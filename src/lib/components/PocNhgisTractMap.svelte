		...
		? [
			{
				...
				bodyHtml:
					'This map shows how transit access across Greater Boston is organized around a dense, radial network anchored in the urban core. The MBTA subway lines, including the Red, Orange, Blue, and Green lines, cluster tightly around Boston and Cambridge, while the commuter rail stretches outward along longer corridors into surrounding suburbs, with services like the CapeFLYER extending even farther toward the Cape. Together, they create a hub and spoke system where the most frequent and reliable transit, and therefore the easiest access to jobs, services, and daily life, is concentrated near the center, gradually becoming more limited and directional farther out.<br><br>This geography sets up where transit-linked opportunity is strongest. These are the places where housing development could most directly connect residents to jobs and services, which raises an important question about whether new housing is actually being built in ways that expand that access.'
			},
			{
				kicker: 'Step 2',
				title: 'Where Housing Growth Is Happening',
				bodyHtml:
					'This map layers housing growth onto the transit network, showing how development has actually unfolded across the region. Each tract is shaded by change in housing units, with deeper blues indicating stronger growth, reds indicating weaker or negative growth, and lighter tones reflecting limited or less reliable data. The Seaport stands out as the clearest concentration of very strong growth within the urban core, but it is not the only place where growth is happening. Pockets of darker blue also appear farther out, including in parts of Plymouth County, Essex County, and Worcester County.<br><br>Seen alongside transit access, the pattern is more scattered than expected. Some growth aligns with strong transit, but much of it appears beyond the areas with the highest access. If transit-oriented development is working as intended, we might expect growth to concentrate more consistently near the strongest parts of the network. Instead, this begins to raise questions about how housing growth and access to opportunity are actually aligning.'
			},
			{
				kicker: 'Step 3',
				title: 'Looking at the Contrast Up Close',
				bodyHtml:
					'Here, we focus on individual places to make the pattern easier to see. Some tracts are experiencing substantial housing growth even though they are not located within the strongest transit geography. Transit is often still present, but it is less dense, less frequent, or less connected than in the urban core.<br><br>Across these examples, the relationship between growth and transit begins to diverge. Some tracts show very strong growth with relatively limited nearby access, while others sit closer to transit but do not see the same level of development. It is also possible to find tracts along strong transit corridors that show little or even negative housing growth.<br><br>This contrast begins to challenge the assumption that transit access alone drives where housing gets built. Growth is happening both within and beyond the strongest transit areas, suggesting that other forces are shaping where development occurs and who is likely to benefit from it.'
			},
			{
				kicker: 'Step 4',
				title: 'A measurable mismatch',
				bodyHtml:
					'Here, the pattern becomes explicit. The map highlights the tracts where transit access and housing growth pull apart. Solid purple outlines mark places with strong transit access but relatively little or even negative housing growth. Dashed purple outlines mark the opposite pattern, where housing growth is strong despite weaker or minimal transit access.<br><br>Across the region, both types of mismatch appear. In parts of Suffolk County, there are tracts with dozens of nearby MBTA stops that have seen little or even negative housing growth. At the same time, in places like Worcester County and Plymouth County, there are tracts with little to no transit access that have still experienced substantial growth.<br><br>This does not mean that growth outside transit is inherently negative, but it does highlight a disconnect between where housing is being added and where access is strongest. The examples highlighted in the cards below, and marked with red insight markers, make this pattern easier to see by grounding it in specific places.'
			},
			{
				kicker: 'Step 5',
				title: 'How Growth Is Distributed Relative to Transit',
				bodyHtml:
					'Instead of only identifying mismatch, this step introduces a clearer classification. Tracts are grouped based on how development is distributed relative to transit. Green outlines mark places where significant development has been more transit-oriented, while orange outlines mark places where growth has leaned more toward non-TOD patterns.<br><br>The choropleth still shows housing growth underneath, but this grouping adds a second layer of meaning. It shows not just where growth happened, but whether that growth was concentrated near transit or occurred more outside of it. This helps move from observing mismatch to understanding how different places relate to transit-oriented development as a housing strategy.<br><br>Across the region, many TOD-dominated tracts cluster around the urban core and along major MBTA lines, while non-TOD-dominated tracts appear more dispersed, especially farther from high-frequency transit. This framing helps connect spatial patterns to questions about access and who is most likely to benefit from new housing.'
			},
			{
				kicker: 'Step 6',
				title: 'Boston and Cambridge',
				bodyHtml:
					'This zoom focuses on Boston and Cambridge as a reference case within the most transit-rich part of the region. Most tracts here are TOD-dominated, which is expected given the density and connectivity of the MBTA network. Development in many of these areas aligns closely with transit, reinforcing access to jobs and services.<br><br>At the same time, the pattern is not uniform. There are areas with minimal development, with some tracts showing low or even negative housing growth. Even in places with strong transit access, new housing is not being added consistently.<br><br>This represents the strongest case for how transit-oriented development can work, but it also shows its limits. If TOD alone determined outcomes, we would expect both consistent alignment and consistently high growth across these tracts. Instead, development varies even within the most connected areas.'
			},
			{
				kicker: 'Step 7',
				title: 'Quincy and Revere',
				bodyHtml:
					'Moving outward to Quincy and Revere, the pattern becomes more mixed. Transit access is still present, but nearby tracts do not all show the same relationship between growth and transit-oriented development. Compared to Boston and Cambridge, there are slightly more non-TOD-dominated tracts, even in areas with similar access.<br><br>Some tracts with comparable proximity to transit fall into different categories and show different levels of housing growth. There are also areas with minimal development, with some tracts showing low or even negative growth.<br><br>This step shows that the relationship between transit access and housing development becomes less consistent outside the core. Transit presence alone does not determine whether growth occurs or whether it is closely tied to transit.'
			},
			{
				kicker: 'Step 8',
				title: 'Outer-Ring Growth',
				bodyHtml:
					'In the outer ring of the region, the pattern shifts more clearly. Many of these tracts sit farther from the strongest MBTA geography, and as a result, much of the development clusters into non-TOD-dominated tracts.<br><br>Transit is still present in some areas, but it is more limited, less frequent, and more directional. Growth in these places tends to be more dispersed and less closely tied to transit access. There are still some TOD-dominated tracts, often near commuter rail lines, but they are fewer and more scattered.<br><br>This represents the clearest divergence from the expected alignment between housing growth and transit. While development is still occurring, it is often happening in ways that are less connected to strong transit access.'
			},
			{
				kicker: 'Step 9',
				title: 'Projects Enter the Picture',
				bodyHtml:
					'This step brings the analysis down to the level of individual developments. Each dot represents a project, with size reflecting the number of units and color showing the share of multi-family housing, ranging from white to purple. A green outline marks projects that are transit-accessible, while a yellow outline marks those that are not.<br><br>Across the map, one pattern stands out clearly. Most projects are overwhelmingly multi-family, with many developments appearing at or near 100 percent multi-family. Larger, denser projects tend to cluster near the urban core, while smaller or less dense developments are more widely distributed.<br><br>At the same time, projects are not limited to the strongest transit areas. Development is occurring across a wide geography, including places with weaker access. Many projects, even in highly accessible areas, include little or no affordable housing, which limits who can benefit from that access.'
			},
			{
				kicker: 'Step 10',
				title: 'Projects as Examples',
				bodyHtml:
					'This step highlights a small set of developments that make the broader pattern easier to interpret. Some projects, like Assembly Row and 16 Boardman St, represent strong transit-oriented development, where dense housing is built directly alongside rapid transit. Others, like 16 Dyer, are near transit but less tightly integrated. On the other end, projects like Mahoney Farm and The Pinehills show that substantial housing growth can occur far from strong transit access.<br><br>These examples show that housing growth takes many forms. Some projects align closely with transit and reflect the goals of TOD as a housing policy, while others contribute to growth in more car-dependent areas. At the same time, affordability varies across these cases, and many projects include few or no affordable units.<br><br>Together, these examples make it clear that where housing is built, how it connects to transit, and whether it includes affordable units all shape who is able to benefit from new development.'
			},
			{
				kicker: 'Step 11',
				title: 'Who This Affects',
				bodyHtml:
					'In this final step, higher-income tracts fade into the background, where high income is defined as greater than $125k per year and lower income as less than $125k. This makes it easier to focus on where lower-income communities sit within the patterns we have seen.<br><br>Many lower-income tracts appear within the mismatch categories. Some are located in high-access areas that have seen little housing growth, where limited supply can contribute to rising costs and displacement pressure. Others are in areas that have experienced growth but are farther from strong transit, where access to jobs and services may remain more limited.<br><br>Looking at the TOD and non-TOD grouping adds another layer. Among lower-income tracts, there appear to be more areas with minimal development overall, even in places with transit access. Where development does occur, it is not always strongly transit-oriented.<br><br>This shifts the focus from where housing is built to who it serves. Transit-oriented development can expand access to opportunity, but without affordability, it does not guarantee that lower-income households are able to benefit. When housing growth, transit access, and affordability do not align, the people who rely on transit the most are often the least able to access it.'
			}
		]
		: [
			{

		...
		? [
			{
				...
				bodyHtml:
					'This map shows how transit access across Greater Boston is organized around a dense, radial network anchored in the urban core. The MBTA subway lines, including the Red, Orange, Blue, and Green lines, cluster tightly around Boston and Cambridge, while the commuter rail stretches outward along longer corridors into surrounding suburbs, with services like the CapeFLYER extending even farther toward the Cape. Together, they create a hub and spoke system where the most frequent and reliable transit, and therefore the easiest access to jobs, services, and daily life, is concentrated near the center, gradually becoming more limited and directional farther out.<br><br>This geography helps frame what we should expect from housing growth. Areas with the strongest transit access are the places best positioned to support new housing and expand opportunity. When growth in these neighborhoods is not paired with enough affordable housing, it can make them harder to stay in for the people who depend on that access most. At the same time, development farther from the network can leave residents more disconnected from jobs and services. Seen this way, the map becomes a baseline for asking whether new housing is reinforcing access or reshaping who gets to benefit from it.'
			},
			{
				kicker: 'Step 2',
				title: 'The geography of housing growth',
				bodyHtml:
					'This map layers housing growth onto the transit network, showing how development has actually unfolded across the region. Each tract is shaded by change in housing units, with deeper blues indicating stronger growth, reds indicating weaker or negative growth, and lighter tones reflecting limited or less reliable data. The Seaport stands out as the clearest concentration of very strong growth within the urban core, but it is not the only place where growth is happening. Pockets of darker blue also appear farther out, including in parts of Plymouth County, Essex County, and even into Worcester County, pointing to meaningful growth beyond the most transit-rich areas.<br><br>Seen alongside the previous map, this begins to shift the story. If housing growth were closely following transit access, the strongest growth would cluster tightly around the subway network and its immediate surroundings. Instead, the pattern is more uneven, with growth both in well-connected areas and in places that are more peripheral to the MBTA network. This raises a more nuanced question about access and equity. Growth in highly connected areas like the Seaport can expand opportunity, but without enough affordable housing, it can also make those areas harder to remain in. At the same time, growth farther from the network may increase housing supply, but in locations that offer fewer connections to jobs and services. Together, these patterns begin to show that housing growth and transit access are not aligning as cleanly as we might expect.'
			},
			{
				kicker: 'Step 3',
				title: 'Looking at the Contrast Up Close',
				bodyHtml:
					'Here, we focus on individual places to make the pattern easier to see. The same map now highlights a few tracts that help ground the broader regional story. Some areas are experiencing substantial housing growth even though they are not located within the strongest transit geography. Transit is often still present, but it is less dense, less frequent, or less connected than in the urban core.<br><br><strong>How to read it:</strong> Stay with the choropleth, but shift your attention to specific tracts. These examples are not meant to represent the whole region, but to make the broader pattern more concrete.<br><br>Across these examples, the relationship between growth and transit begins to diverge. One tract in Suffolk County shows extremely high growth alongside high incomes, even within a relatively transit-accessible context. A tract in Middlesex County shows similarly strong growth but with fewer nearby stops and lower median income. You can also imagine a tract farther from the core with high growth along a single commuter rail line, where access exists but is more limited and directional. At the same time, there are tracts directly along strong transit corridors like the Green Line that show little or even negative housing growth.<br><br>This contrast complicates the idea that transit access alone determines where housing gets built. Growth is happening both in and beyond the strongest MBTA geography, and in some well-connected areas, it is not happening much at all. These examples make it easier to see that the relationship between transit and housing is not just uneven, but selective, shaped by factors like income, development pressure, and local constraints.'
			},
			{
				kicker: 'Step 4',
				title: 'A measurable mismatch',
				bodyHtml:
					'Here, we make the pattern explicit. Instead of just observing differences between transit access and housing growth, the map now highlights the tracts where they clearly pull apart. Solid purple outlines mark places with strong transit access but relatively little or even negative housing growth. Dashed purple outlines mark the opposite pattern, where housing growth is strong despite weaker or minimal transit access.<br><br><strong>How to read it:</strong> The outlines sit on top of the same choropleth from before. They do not replace the growth patterns underneath, but instead call attention to where the relationship between access and growth breaks down in a meaningful way.<br><br>Across the region, both types of mismatch appear. In parts of Suffolk County, there are tracts with dozens of nearby MBTA stops that have seen little or even negative housing growth over the past two decades. At the same time, in places like Worcester County and Plymouth County, there are tracts with little to no transit access that have still experienced substantial growth. These are not isolated anomalies, but part of a broader pattern visible across the map.<br><br>The examples highlighted in the cards below, and marked on the map with red insight markers, make this pattern easier to read. Some of these tracts sit in the heart of the transit network yet show declining or stagnant housing stock, suggesting that access alone does not guarantee development. Others are growing quickly despite being far from frequent, reliable transit, pointing to different forces shaping where housing gets built.<br><br>Taken together, these mismatches make the core argument visible. Housing growth and transit access are not consistently moving together. Instead, they often diverge, shaping a region where some of the most connected places are not absorbing new housing, while growth continues in areas with fewer connections to opportunity.'
			},
			{
				kicker: 'Step 5',
				title: 'How Growth Is Distributed Relative to Transit',
				bodyHtml:
					'Before zooming into specific places, the map now shifts from identifying mismatches to grouping tracts across the entire region. Instead of just seeing mismatch, we can now classify how growth relates to transit in each place. Tracts are outlined based on how their development is distributed relative to transit. Green outlines mark places where significant development has been more transit-oriented, while orange outlines mark places where growth has leaned more toward non-TOD patterns.<br><br>The choropleth still shows housing growth underneath, but the outlines introduce a second layer of meaning. They show not just where growth happened, but whether that growth was concentrated near transit or occurred more outside of it. Across the region, a clear pattern emerges. Many of the green, TOD-dominated tracts cluster around the urban core and along major MBTA lines, where access is strongest. In contrast, orange outlines are more widely dispersed, especially in areas farther from frequent transit, where development is happening in a more car-dependent way.<br><br>This view connects the earlier mismatch to a more concrete way of understanding it. Instead of only seeing that growth and transit do not always align, we can now see how growth is actually distributed relative to transit access in each place. The examples that follow in Steps 6 through 8 build on this, using specific cities to show what these patterns look like on the ground.'
			},
			{
				kicker: 'Step 6',
			...
			},
			{
				...
				bodyHtml:
					'This step brings the analysis down to the level of individual developments. The map now overlays project-level data on top of the tract patterns, connecting the broader trends in housing growth to the actual places where new units are being built.<br><br>Each dot represents a development. Dot size reflects the number of units, so larger circles indicate larger projects. Color encodes the share of multi-family units, ranging from white to purple, drawing on the commuter rail color palette. A green outline marks projects that are transit-accessible, while a yellow outline marks those that are not.<br><br>Across the map, one pattern stands out clearly. Most projects are overwhelmingly multi-family, with many developments appearing at or near 100 percent multi-family. These projects are especially concentrated in and around the urban core, where larger, denser developments cluster near strong transit access. At the same time, projects are distributed across a wider geography, including areas that were identified as less transit-oriented or farther from the strongest MBTA access.<br><br>This makes it clear that the mismatch is not just an artifact of how we summarize data by tract. It also shows up in where individual developments are actually happening on the ground and in the types of housing being built. Even though most new housing is multi-family, it is not consistently located in the places with the strongest transit access.<br><br>The next step builds on this by focusing on different types of projects, distinguishing between those that are strongly transit-oriented, those that are simply near transit, and those that highlight the contrast in areas with weaker access.'
			},
			{
				kicker: 'Step 10',
				title: 'Projects as Examples',
				body: 'This step narrows the focus to a small set of developments that make the broader pattern easier to interpret. Instead of looking at the full field of projects, these examples highlight how different types of housing growth relate to transit access, scale, and affordability.<br><br>These projects fall along a spectrum. Some, like Assembly Row and 16 Boardman St, represent strong transit-oriented development, where dense, multi-family housing is built directly alongside rapid transit. Others, like 16 Dyer, sit in a middle ground. They are near transit, but not as tightly integrated into the network as the strongest TOD cases. On the other end, projects like Mahoney Farm and The Pinehills show that substantial housing growth can occur far from the strongest transit access, often at larger scales and in more car-dependent contexts.<br><br>Looking across these examples, differences in both location and project characteristics become more visible. Strong TOD cases tend to cluster near high-frequency transit and are often dense and multi-family. In contrast, non-TOD examples are more geographically dispersed and less tied to transit access. At the same time, affordability varies across all of these cases. Some projects include affordable units, but many do not, even when they are located in highly accessible areas.<br><br>These examples help bring the earlier patterns into focus. Housing growth is not only uneven across space, but also varies in how it connects to transit and in who it is likely to serve. Together, they highlight that proximity to transit, project scale, and affordability all shape how new development translates into real access to opportunity.'
			},
			{
				kicker: 'Step 11',
				title: 'Who This Affects',
				body: 'In this final step, higher-income tracts fade into the background, where high income is defined as greater than $125k per year and lower income as less than $125k. This makes it easier to focus on where lower-income communities sit within the relationship between transit access and housing growth.<br><br>What comes into view is not just where mismatch exists, but where it may matter most. Lower-income tracts appear on both sides of the disconnect. Some are located in high-access areas that have seen little housing growth, where limited new supply can contribute to rising costs and displacement pressure. Others are in areas that have experienced growth but are farther from strong transit, where access to jobs and services may remain more limited.<br><br>Looking at the mismatch outlines, a striking pattern emerges. Many of the lower-income tracts fall within these mismatch categories, either as high-access, low-growth places or as higher-growth, lower-access places. While not every low-income tract is a mismatch, a large share appear to sit inside this disconnect, suggesting that the misalignment between transit and housing is closely tied to where lower-income households live.<br><br>Looking at the TOD versus non-TOD grouping adds another layer. Among lower-income tracts, there appear to be more areas with minimal development overall, even in places with transit access. This suggests that not only is growth uneven, but in many lower-income areas, it may be limited altogether. Where development does occur, it is not always strongly transit-oriented, which can further shape access to opportunity.<br><br>Together, these views shift the question from where housing is built to who it serves. The mismatch between transit access and housing growth is not only a planning issue, but also a question of equity. When growth is not aligned with access, and when affordability is limited, lower-income households are less likely to benefit from the region’s most connected and opportunity-rich places.'
			}
		]
		: [
			{
